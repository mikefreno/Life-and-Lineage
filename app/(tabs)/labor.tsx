            ...
            {tutorialStep == 1 ? (
              <>
                ...
                <Text className="text-center text-lg">
                  Come here to earn gold in a (mostly) safe way. Certain jobs
                  have qualifications which you can earn by going to the
                  training school (top right).
                </Text>
                <Pressable
              ...
              <>
                ...
                <Text className="my-4 text-center text-lg">
                  The dungeon, it is far more dangerous than any job, but
                  promises great riches.
                </Text>
                <Pressable
