...
export const StatsDisplay = observer(
  ({
    ...
    const RequirementsBlock = () => {
      ...
      if (
        (reqs.intelligence || reqs.strength || reqs.dexterity) &&
        playerState
      ) {
    ...
    return (
      <View style={{ pointerEvents: "box-none", flex: 1, zIndex: 9999 }}>
        <GenericModal
        ...
        >
          ...
          >
            <Text
              style={{ marginTop: -8, marginLeft: 0, ...styles["text-2xl"] }}
            >
              x
            </Text>
          </Pressable>
